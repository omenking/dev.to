...
Rails.application.routes.draw do
  ...
  get "dashboard/user_following" => "dashboards#following"
  get "dashboard/organization_following" => "dashboards#organization_following"
  get "dashboard/tags" => "dashboards#tags"
